...
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.CREATION_TIME;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.DELIVERY_LOCALITY;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.DESCRIPTION;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.DISTANCE;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.FARE;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.HEIGHT;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.LENGTH;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.SHIPPING_LOCALITY;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.SHIPPING_STATUS;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.SHIPPING_STATUS_NAME;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.USER;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.VOLUME;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.WEIGHT;
import static com.epam.spring.cargo_delivery.service.test.util.TestOrderDataUtil.WIDTH;
